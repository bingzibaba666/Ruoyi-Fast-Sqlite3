...
public class TokenWebService
{
     ...
     * @return 用户信息
     */
    public LoginWebUser getLoginUser(HttpServletRequest request)
    {
        // 获取请求携带的令牌
        ...
        if (StringUtils.isNotEmpty(token))
        {
            ...
            LoginWebUser user = ehcacheClient.get(userKey);
            return user;
        }
        return null;
    }
     ...
     * @return 令牌
     */
    public String createToken(LoginWebUser loginUser)
    {
     ...
     * @return 令牌
     */
    public void verifyToken(LoginWebUser loginUser)
    {
     ...
     */
    public void refreshToken(LoginWebUser loginUser)
    {
        loginUser.setLoginTime(System.currentTimeMillis());
        loginUser.setExpireTime(loginUser.getLoginTime() + expireTime * MILLIS_MINUTE);
        // 根据uuid将loginUser缓存
        String userKey = getTokenKey(loginUser.getToken());
        ehcacheClient.set(userKey,expireTime*60, loginUser);
    }
