...
public class SysUserOnlineController extends BaseController
{
    ...
    {
        Collection<String> keys = ehcacheClient.keys(Constants.LOGIN_TOKEN_KEY + "*");
        List<SysUserOnline> userOnlineList = new ArrayList<SysUserOnline>();
        for (String key : keys)
        {
            LoginUser user = ehcacheClient.get(key);
    ...
    {
        ehcacheClient.delete(Constants.LOGIN_TOKEN_KEY + tokenId);
