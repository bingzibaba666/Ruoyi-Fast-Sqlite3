...
public class StringUtils extends org.apache.commons.lang3.StringUtils
{
	...
	/*public static String base64Encode(String str) {
		String s = "";
		try {
			s = Base64.encodeBase64String(str.getBytes("UTF-8"));
	...
	/*public static String base64Decode(String str) {
		String s = "";
		try {
			s = new String(Base64.decodeBase64(str),"UTF-8");
		} catch (UnsupportedEncodingException e) {
			e.printStackTrace();
		}
		return s;
	...
	public static String getStringByRemoveComma(Object oldStr){
		return oldStr==null?"":oldStr.toString().trim().replaceAll(",", "").replaceAll("，", "");
	}
